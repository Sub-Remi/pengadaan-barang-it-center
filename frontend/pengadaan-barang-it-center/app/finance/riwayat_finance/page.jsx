...
export default function RiwayatFinancePage() {
  const data = [
    { no: 1, idpb: "10111", tanggal: "01/01/2025", divisi: "HR", status: "Selesai" },
    { no: 2, idpb: "10777", tanggal: "02/06/2025", divisi: "Marketing", status: "Selesai" },
    { no: 3, idpb: "10222", tanggal: "24/04/2025", divisi: "Finance", status: "Selesai" },
    { no: 4, idpb: "115551", tanggal: "04/10/2025", divisi: "IT", status: "Ditolak" },
    { no: 5, idpb: "110110", tanggal: "05/05/2025", divisi: "Marketing", status: "Ditolak" },
  ];
        ...
        <main className="flex-1 p-8 bg-gray-200">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="flex justify-between items-center px-6 py-5 border-b">
              <h3 className="text-xl font-semibold text-teal-600">Riwayat Pembelian</h3>
            </div>
