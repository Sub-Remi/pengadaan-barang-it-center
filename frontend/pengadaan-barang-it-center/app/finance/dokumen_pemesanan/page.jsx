        ...
        <main className="flex-1 mt-20 overflow-y-auto bg-gray-200 p-8">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="flex justify-between items-center px-6 py-5 border-b-4 border-b-gray-300">
              <h3 className="text-xl font-semibold text-teal-600">Cek Dokumen Peemesanan</h3>
              <Link href="/finance/data_pemesanan">
            ...
            <div className="px-6 pt-6 pb-4 border-b border-b-gray-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="text-base font-medium mt-4 mb-3 text-gray-700">Nota</h4>
                ...
                <div>
                  <h4 className="text-base font-medium mt-4 mb-3 text-gray-700">PO</h4>
                  <div className="p-4 bg-white border border-gray-200 rounded">
                    <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-base font-medium mt-4 mb-3 text-gray-700">Form Permintaan</h4>
                  <div className="p-4 bg-white border border-gray-200 rounded">
                    <div className="flex gap-6">
