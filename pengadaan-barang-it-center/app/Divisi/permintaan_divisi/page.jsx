...
export default function PermintaanPage() {
  const data = [
    { no: 1, idPB: "00000", divisi: "HR", tanggal: "dd/mm/yyyy", status: "Menunggu" },
    { no: 2, idPB: "00000", divisi: "Marketing", tanggal: "dd/mm/yyyy", status: "Selesai" },
    { no: 3, idPB: "00000", divisi: "Finance", tanggal: "dd/mm/yyyy", status: "Menunggu" },
    { no: 4, idPB: "00000", divisi: "IT", tanggal: "dd/mm/yyyy", status: "Diproses" },
    { no: 5, idPB: "00000", divisi: "Marketing", tanggal: "dd/mm/yyyy", status: "Menunggu" },
  ];
